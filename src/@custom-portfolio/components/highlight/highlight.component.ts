...
import { CustomPortfolioHighlightService } from '@custom-portfolio/components/highlight/highlight.service';

@Component({
    selector: 'textarea[custom-portfolio-highlight]',
    templateUrl: './highlight.component.html',
    styleUrls: ['./highlight.component.scss'],
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs: 'custom-portfolioHighlight',
    standalone: true,
    imports: [NgClass],
})
export class CustomPortfolioHighlightComponent implements OnChanges, AfterViewInit {
    private _domSanitizer = inject(DomSanitizer);
    private _elementRef = inject(ElementRef);
    private _custom-portfolioHighlightService = inject(CustomPortfolioHighlightService);
    ...
    private _highlightAndInsert(): void {
        ...
        this.highlightedCode = this._domSanitizer.sanitize(
            ...
            this._custom-portfolioHighlightService.highlight(this.code, this.lang)
        );
