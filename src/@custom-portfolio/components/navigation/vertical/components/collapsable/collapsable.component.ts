...
@Component({
    selector: 'custom-portfolio-vertical-navigation-collapsable-item',
    ...
    imports: [
        ...
        forwardRef(() => CustomPortfolioVerticalNavigationCollapsableItemComponent),
...
export class CustomPortfolioVerticalNavigationCollapsableItemComponent
    implements OnInit, OnDestroy
{
    ...
    @HostBinding('class') get classList(): any {
        /* eslint-disable @typescript-eslint/naming-convention */
        return {
            'custom-portfolio-vertical-navigation-item-collapsed': this.isCollapsed,
            'custom-portfolio-vertical-navigation-item-expanded': this.isExpanded,
        };
        /* eslint-enable @typescript-eslint/naming-convention */
    }
    ...
    ngOnInit(): void {
        ...
        this._custom-portfolioVerticalNavigationComponent.onCollapsableItemCollapsed
        ...
        if (this.autoCollapse) {
            this._custom-portfolioVerticalNavigationComponent.onCollapsableItemExpanded
                .pipe(takeUntil(this._unsubscribeAll))
    ...
    collapse(): void {
        ...
        this._custom-portfolioVerticalNavigationComponent.onCollapsableItemCollapsed.next(
            this.item
        );
    }
    ...
    expand(): void {
        ...
        // Execute the observable
        this._custom-portfolioVerticalNavigationComponent.onCollapsableItemExpanded.next(
            this.item
        );
    }
    ...
    private _hasActiveChild(
        item: CustomPortfolioNavigationItem,
        currentUrl: string
    ): boolean {
    ...
    private _isChildrenOf(
        parent: CustomPortfolioNavigationItem,
        item: CustomPortfolioNavigationItem
    ): boolean {
