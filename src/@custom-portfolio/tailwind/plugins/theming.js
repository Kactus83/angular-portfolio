...
// -----------------------------------------------------------------------------------------------------
// @ CUSTOM_PORTFOLIO TailwindCSS Main Plugin
// -----------------------------------------------------------------------------------------------------
                        ...
                        _.fromPairs(
                            _.flatten(
                                _.map(
                                    ...
                                    (value, key) => [
                                        [`--custom-portfolio-${e(key)}`, value],
                                        [
                                            `--custom-portfolio-${e(key)}-rgb`,
            ...
            const schemeCustomProps = _.map(
                ...
                (colorScheme) => {
                    ...
                    const background = theme(
                        `custom-portfolio.customProps.background.${colorScheme}`
                    );
                    const foreground = theme(
                        `custom-portfolio.customProps.foreground.${colorScheme}`
                    );
                        ...
                        _.flatten(
                            _.map(
                                ...
                                (name) => [
                                    [
                                        name,
                                        `rgba(var(--custom-portfolio-${name}-rgb), <alpha-value>)`,
                                    ],
                                    [
                                        `on-${name}`,
                                        `rgba(var(--custom-portfolio-on-${name}-rgb), <alpha-value>)`,
                                    ],
                                ]
                            )
                        )
