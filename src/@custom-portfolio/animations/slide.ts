...
import {
    CustomPortfolioAnimationCurves,
    CustomPortfolioAnimationDurations,
} from '@custom-portfolio/animations/defaults';
...
const slideInTop = trigger('slideInTop', [
    ...
    transition('void => *', animate('{{timings}}'), {
        params: {
            timings: `${CustomPortfolioAnimationDurations.entering} ${CustomPortfolioAnimationCurves.deceleration}`,
        },
    }),
]);
...
const slideOutTop = trigger('slideOutTop', [
    ...
    transition('* => void', animate('{{timings}}'), {
        params: {
            timings: `${CustomPortfolioAnimationDurations.exiting} ${CustomPortfolioAnimationCurves.acceleration}`,
        },
    }),
]);
