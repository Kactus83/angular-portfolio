...
import { CustomPortfolioConfigService } from '@custom-portfolio/services/config';
import { fromPairs } from 'lodash-es';
import { Observable, ReplaySubject, map, switchMap } from 'rxjs';

@Injectable({ providedIn: 'root' })
export class CustomPortfolioMediaWatcherService {
    private _breakpointObserver = inject(BreakpointObserver);
    private _custom-portfolioConfigService = inject(CustomPortfolioConfigService);
     ...
     */
    constructor() {
        this._custom-portfolioConfigService.config$
            .pipe(
                map((config) =>
                    fromPairs(
