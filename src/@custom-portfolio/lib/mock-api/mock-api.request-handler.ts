...
import { CustomPortfolioMockApiReplyCallback } from '@custom-portfolio/lib/mock-api/mock-api.types';
import { Observable, of, take, throwError } from 'rxjs';

export class CustomPortfolioMockApiHandler {
    request!: HttpRequest<any>;
    urlParams!: { [key: string]: string };

    // Private
    private _reply: CustomPortfolioMockApiReplyCallback = undefined;
     ...
     * @param callback
     */
    reply(callback: CustomPortfolioMockApiReplyCallback): void {
        // Store the reply
