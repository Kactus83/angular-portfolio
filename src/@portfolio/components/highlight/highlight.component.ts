...
import { PortfolioHighlightService } from '@portfolio/components/highlight/highlight.service';

@Component({
    selector: 'textarea[portfolio-highlight]',
    templateUrl: './highlight.component.html',
    styleUrls: ['./highlight.component.scss'],
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs: 'portfolioHighlight',
    standalone: true,
    imports: [NgClass],
})
export class PortfolioHighlightComponent implements OnChanges, AfterViewInit {
    private _domSanitizer = inject(DomSanitizer);
    private _elementRef = inject(ElementRef);
    private _portfolioHighlightService = inject(PortfolioHighlightService);
    ...
    private _highlightAndInsert(): void {
        ...
        this.highlightedCode = this._domSanitizer.sanitize(
            ...
            this._portfolioHighlightService.highlight(this.code, this.lang)
        );
