...
export class PortfolioNavigationService {
    ...
    private _navigationStore: Map<string, PortfolioNavigationItem[]> = new Map<
        string,
        any
    >();
     ...
     * @param navigation
     */
    storeNavigation(key: string, navigation: PortfolioNavigationItem[]): void {
        // Add to the store
     ...
     * @param key
     */
    getNavigation(key: string): PortfolioNavigationItem[] {
    ...
    getFlatNavigation(
        ...
        flatNavigation: PortfolioNavigationItem[] = []
    ...
    getItemParent(
        id: string,
        navigation: PortfolioNavigationItem[],
        parent: PortfolioNavigationItem[] | PortfolioNavigationItem
    ): PortfolioNavigationItem[] | PortfolioNavigationItem | null {
        for (const item of navigation) {
            if (item.id === id) {
                return parent;
            }
