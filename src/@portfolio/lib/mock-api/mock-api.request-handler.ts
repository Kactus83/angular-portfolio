...
import { PortfolioMockApiReplyCallback } from '@portfolio/lib/mock-api/mock-api.types';
import { Observable, of, take, throwError } from 'rxjs';

export class PortfolioMockApiHandler {
    request!: HttpRequest<any>;
    urlParams!: { [key: string]: string };

    // Private
    private _reply: PortfolioMockApiReplyCallback = undefined;
     ...
     * @param callback
     */
    reply(callback: PortfolioMockApiReplyCallback): void {
        // Store the reply
