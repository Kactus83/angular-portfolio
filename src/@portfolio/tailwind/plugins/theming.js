...
// -----------------------------------------------------------------------------------------------------
// @ PORTFOLIO TailwindCSS Main Plugin
// -----------------------------------------------------------------------------------------------------
            ...
            const schemeCustomProps = _.map(
                ...
                (colorScheme) => {
                    ...
                    const background = theme(
                        `portfolio.customProps.background.${colorScheme}`
                    );
                    const foreground = theme(
                        `portfolio.customProps.foreground.${colorScheme}`
                    );
                        ...
                        _.flatten(
                            _.map(
                                ...
                                (name) => [
                                    [
                                        name,
                                        `rgba(var(--portfolio-${name}-rgb), <alpha-value>)`,
                                    ],
                                    [
                                        `on-${name}`,
                                        `rgba(var(--portfolio-on-${name}-rgb), <alpha-value>)`,
                                    ],
                                ]
                            )
                        )
